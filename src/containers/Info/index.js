    ...
    return (
        <div className="info">
            ...
            <div className="info__item">
                ...
                <span className="info__content">{(dataItem && dataItem.address && dataItem.address.streetAddress) || ""}</span>
            </div>
            <div className="info__item">
                <b className="info__title">City:</b>
                <span className="info__content">{(dataItem && dataItem.address && dataItem.address.city) || ""}</span>
            </div>
            <div className="info__item">
                <b className="info__title">State:</b>
                <span className="info__content">{(dataItem && dataItem.address && dataItem.address.state) || ""}</span>
            </div>
            <div className="info__item">
                <b className="info__title">ZIP:</b>
                <span className="info__content">{(dataItem && dataItem.address && dataItem.address.zip) || ""}</span>
            </div>
        </div>
    );
}
